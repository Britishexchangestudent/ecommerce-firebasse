      ...
      <div className="relative">
        ...
        <div className="relative max-w-3xl mx-auto pb-96 px-4 text-center sm:pb-0 sm:px-6 lg:px-8">
          ...
          <div className="relative py-32">
            <h1 className="text-4xl font-extrabold tracking-tight text-primaryTextLight sm:text-5xl md:text-6xl">
              Mid-Season Sale
            </h1>
            <div className="mt-4 sm:mt-6">
              <a
                href="#"
                className="inline-block bg-primaryPurple border border-transparent rounded-md py-3 px-8 font-medium text-primaryTextLight hover:bg-indigo-700 duration-200"
              >
                Shop Collection
              </a>
            </div>
        ...
        >
          ...
          <div className="max-w-md mx-auto grid grid-cols-1 gap-y-6 px-4 sm:max-w-7xl sm:px-6 sm:grid-cols-3 sm:gap-y-0 sm:gap-x-6 lg:px-8 lg:gap-x-8">
            {collections.map((collection) => (
              <StoreFrontImages collection={collection} />
            ))}
          </div>
        </section>
      </div>
      ...
      <section aria-labelledby="trending-heading">
        <div className="max-w-7xl mx-auto py-24 px-4 sm:px-6 sm:py-32 lg:pt-32 lg:px-8">
          <div className="md:flex md:items-center md:justify-between">
            ...
            <a
              href="#"
              className="hidden text-sm font-medium text-primaryPurple hover:text-primaryPurpleHover md:block"
            >
          ...
          <div className="mt-8 text-sm md:hidden">
            <a
              href="#"
              className="font-medium text-primaryPurple hover:text-primaryPurpleHover"
            >
              Shop the collection<span aria-hidden="true"> &rarr;</span>
            </a>
          </div>
