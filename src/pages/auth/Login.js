...
function Login() {
  ...
  return (
    <div className="h-screen w-full">
      <AnimatePresence>
        {registerModal && <CreateAccount setRegisterModal={setRegisterModal} />}
            ...
            <div>
              <div>
                ...
                <div className="mt-1 grid grid-cols-3 gap-3">
                  ...
                  <div>
                    <div className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 cursor-pointer duration-200">
                      <img
